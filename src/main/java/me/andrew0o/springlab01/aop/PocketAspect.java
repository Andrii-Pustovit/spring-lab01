package me.andrew0o.springlab01.aop;
...
public class PocketAspect {
    ...
    @Pointcut("execution(* me.andrew0o.springlab01.Pocket.setItem(..))")
    public void setItemMethod() {}

    // Pointcut для всіх методів getWidth в класі Pocket
    @Pointcut("execution(int me.andrew0o.springlab01.Pocket.getWidth())")
    public void getWidthMethod() {}

    // Pointcut для всіх методів getHeight в класі Pocket
    @Pointcut("execution(int me.andrew0o.springlab01.Pocket.getHeight())")
